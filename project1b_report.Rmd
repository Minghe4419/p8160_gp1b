...
ggplot(filter(simulation_results_gee, lambda_base == max(lambda_base)), aes(x = rho, y = type1_error_rate)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
...
ggplot(filter(simulation_results_gee, rho==min(rho)), aes(x = lambda_base, y = type1_error_rate)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
  labs(title = "Type I Error Rate in OLS Regression",
       x = "Lambda", y = "Type I Error Rate",
       color = "Correlation Level") +
  theme_minimal()

# Plot Coverage Probability vs. Correlation
ggplot(filter(simulation_results_gee, lambda_base==max(lambda_base)), aes(x = rho, y = coverage_prob)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
...
ggplot(filter(simulation_results_gee, rho==min(rho)), aes(x = lambda_base, y = coverage_prob)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
  labs(title = "Coverage Probability of Confidence Intervals",
       x = "Lambda", y = "Coverage Probability") +
  theme_minimal()
...
# Plot Type I Error Rate vs. Correlation
ggplot(filter(simulation_results_ols, lambda_base == max(lambda_base)), aes(x = rho, y = type1_error_rate)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
...
ggplot(filter(simulation_results_ols, rho==min(rho)), aes(x = lambda_base, y = type1_error_rate)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
  labs(title = "Type I Error Rate in GEE Regression",
       x = "Lambda", y = "Type I Error Rate",
...
# Plot Coverage Probability vs. Correlation
ggplot(filter(simulation_results_ols, lambda_base==max(lambda_base)), aes(x = rho, y = coverage_prob)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
  labs(title = "Coverage Probability of Confidence Intervals",
       x = "Correlation Level", y = "Coverage Probability") +
...
ggplot(filter(simulation_results_ols, rho==min(rho)), aes(x = lambda_base, y = coverage_prob)) +
  geom_line() + geom_point() +
  facet_wrap(~ n_subjects, scales = "fixed") +
  labs(title = "Coverage Probability of Confidence Intervals",
       x = "Lambda", y = "Coverage Probability") +
